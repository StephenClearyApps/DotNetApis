...
namespace DotNetApis.Cecil.UnitTests
{
    public class IdPropertyTests
    {
        ...
        {
            var code = @"public class SampleClass { public int SampleProperty { get; set; } }";
        ...
        {
            var code = @"namespace MyNamespace { public class SampleClass { public int SampleProperty { get; set; } } }";
            var assembly = Compile(code).Dll;
            var type = assembly.Modules.SelectMany(x => x.Types).Single(x => x.Name == "SampleClass");
            var prop = type.Properties.Single(x => x.Name == "SampleProperty");
        ...
        public void Nested()
        {
            var code = @"public class OuterClass { public class SampleClass { public int SampleProperty { get; set; } } }";
            var assembly = Compile(code).Dll;
        ...
        {
            var code = @"namespace Ns { public class OuterClass { public class SampleClass { public int SampleProperty { get; set; } } } }";
            var assembly = Compile(code).Dll;
            var outer = assembly.Modules.SelectMany(x => x.Types).Single(x => x.Name == "OuterClass");
            var type = outer.NestedTypes.Single(x => x.Name == "SampleClass");
            var prop = type.Properties.Single(x => x.Name == "SampleProperty");
        ...
        {
            var code = @"public class SampleClass<TFirst> { public int SampleProperty { get; set; } }";
            var assembly = Compile(code).Dll;
        ...
        {
            var code = @"public class SampleClass { public int this[int index] { get => 0; set { } } }";
            var assembly = Compile(code).Dll;
            var type = assembly.Modules.SelectMany(x => x.Types).Single(x => x.Name == "SampleClass");
        ...
        {
            var code = @"public class SampleClass { public int this[int index, string str] { get => 0; set { } } }";
            var assembly = Compile(code).Dll;
            var type = assembly.Modules.SelectMany(x => x.Types).Single(x => x.Name == "SampleClass");
            var prop = type.Properties.Single(x => x.Name == "Item");
