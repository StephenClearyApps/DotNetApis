...
namespace FunctionApp
{
    ...
    {
        public static void ApplyRequestHandlingDefaults(this HttpRequestMessage request, ExecutionContext context, InMemoryLogger inMemoryLogger)
        {
            ...
            request.GetConfiguration().Services.Replace(typeof(IExceptionHandler), new DetailedExceptionHandler(inMemoryLogger));
        }
